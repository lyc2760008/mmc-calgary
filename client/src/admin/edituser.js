...
export default class UserEdit extends Component {
  ...
  componentDidMount() {
    axios
      .get("http://localhost:5001/user?id=" + this.props.match.params.id)
      .then((response) => {
    ...
    axios
      .get("http://localhost:5001/showroles/")
      .then((response) => {
  ...
  delete(id) {
    console.log(id);
    axios
      .delete("http://localhost:5001/user?id=" + this.props.match.params.id)
      .then((result) => {
  ...
  onSubmit = (e) => {
    ...
    axios
      .put("http://localhost:5001/user?id=" + this.props.match.params.id, {
        first_name,
        last_name,
        email,
        password,
              ...
              <form onSubmit={this.onSubmit}>
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    name="first_name"
                    value={this.state.todos.first_name}
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    name="last_name"
                    value={this.state.todos.last_name}
                    onChange={this.onChange}
